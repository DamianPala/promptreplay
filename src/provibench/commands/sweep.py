...
@click.command(
    ...
    "model's endpoints and drops the ones the stability floor excludes (a status below "
    "zero, or less than 97 % uptime over the last day; --include TAG brings one back), "
    "intersects them with the Zero Data Retention list when --zdr, ranks what is left by "
