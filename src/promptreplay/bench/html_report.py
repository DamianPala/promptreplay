...
from promptreplay.bench.html_layout import (
    chart,
    created,
    created_no_seconds,
    footer,
...
from promptreplay.bench.html_reported import reported_average_section
from promptreplay.bench.html_style import CSS
from promptreplay.bench.html_svg import Point, grouped_bars, horizontal_bars, line_chart
from promptreplay.bench.labels import join_and, size_label
from promptreplay.bench.probe_caveats import (
    caveats_section,
    run_method_sentence,
    tok_footnote_cells,
)
from promptreplay.bench.probe_charts import (
    not_charted,
    price_rows,
    reference_size,
    rung_groups,
...
from promptreplay.bench.probe_html_help import endpoint_help, rung_help
...
from promptreplay.bench.probe_summary import ProbeSummary, summary_from_document
from promptreplay.bench.probe_tables import TableBlock, probe_blocks
from promptreplay.bench.summary import SUMMARY_COLUMNS, cache_mode_note, summary_row
...
def render_html(document: Document) -> str:
    ...
    return "\n".join(
        [
            ...
            f"<title>promptreplay report: {escape(trace)}</title>",
            f"<style>\n{CSS}</style>",
            "</head>",
            "<body>",
            '<main class="page">',
