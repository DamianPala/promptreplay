...
from promptreplay.commands.dry_run import dry_run_fields
from promptreplay.commands.inspect import resolve_trace_path
from promptreplay.commands.prices import native_price_table
from promptreplay.commands.probe_flags import ProbeRequest, options_for, probe_options
from promptreplay.commands.probe_phases import (
    checked_specs,
    confirm,
    planned_specs,
    recorded_sweep,
...
from promptreplay.commands.probe_phases import estimates as planned_estimates
from promptreplay.commands.probe_result import (
    by_price,
    fail_on_partial,
    in_order,
    parallel_note,
...
if TYPE_CHECKING:
    ...
    from promptreplay.bench.probe import ProbeResult
...
def execute_probe(invocation: Invocation, request: ProbeRequest) -> Document:
    ...
    """
    from promptreplay.bench.estimate import precheck_cost, render_estimate
    from promptreplay.bench.probe import run_probe
    from promptreplay.bench.probe_drift import apply_drift
    from promptreplay.bench.probe_runs import endpoint_snapshot, listing_prices, write_probe_run
    ...
    from promptreplay.bench.trace import load_trace, total_prompt_tokens, trace_name
...
def _reported_average(invocation: Invocation, specs: Sequence[RunSpec]) -> ReportedAverage | None:
    ...
    from promptreplay.bench.openrouter_stats import fetch_reported_average
