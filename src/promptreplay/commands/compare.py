...
from promptreplay.commands.run_tables import render_compare
from promptreplay.commands.run_view import COMPARE_OUTPUT, compare_document
...
def compare(ctx: click.Context, run_a: str, run_b: str, trace: str | None, force: bool) -> Document:
    ...
    from promptreplay.bench.run_history import read_run
