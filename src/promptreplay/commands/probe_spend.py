...
def report_spend(
    ...
    *,
    ...
    """
    from promptreplay.bench.spend import precheck_spend, precheck_worst_case, total_spend
    from promptreplay.bench.spend import run_worst_case_usd as _run_worst_case_usd
