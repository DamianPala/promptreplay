...
def _labels(endpoints: Sequence[str]) -> tuple[str | None, dict[str, str]]:
    ...
    from promptreplay.bench.labels import column_labels, rendered
...
def _series_line(
    ...
    *,
    ...
    """
    from promptreplay.bench.summary import sparkline
...
def _stamp(created: object) -> str:
    ...
    from promptreplay.bench.run_history import created_at
