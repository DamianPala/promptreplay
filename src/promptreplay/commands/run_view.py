...
if TYPE_CHECKING:
    ...
    from promptreplay.bench.run_delta import Comparison, MetricPair
    from promptreplay.bench.run_history import RunNumbers, RunRow, Series
...
def history_document(runs: Sequence[RunNumbers], series: Sequence[Series]) -> Document:
    ...
    """
    from promptreplay.bench.run_history import rows_in_order
