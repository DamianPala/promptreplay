...
from promptreplay.commands.run_specs import load_targets, native_specs
from promptreplay.commands.run_tables import render_history
from promptreplay.commands.run_view import HISTORY_OUTPUT, history_document
from promptreplay.core.context import Invocation
from promptreplay.core.documents import Document
from promptreplay.core.errors import NotFound
from promptreplay.core.params import DURATION
...
def history(
    ...
    from promptreplay.bench.run_history import history_series, keep_fresh, scan_runs
...
def _nothing_found(runs_dir: Path, *, model: str | None, trace: str | None) -> NotFound:
    ...
    from promptreplay.bench.run_history import models_in, scan_runs
    ...
    if not everything:
        return NotFound(
            ...
            hint=(
                "Run one first: promptreplay probe TRACE ENDPOINT, "
                "or promptreplay sweep TRACE MODEL"
            ),
        )
