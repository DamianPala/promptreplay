...
def estimates(
    ...
    from promptreplay.bench.estimate import probe_estimate
...
def upper_bound_estimate(
    ...
    *,
    ...
    """
    from promptreplay.bench.estimate import UpperBound, estimate_total, probe_estimate
...
def resolve_index(request: ProbeRequest) -> tuple[dict[str, list[Endpoint]], list[str]]:
    ...
    from promptreplay.commands.run_specs import endpoint_index
...
def run_check(
    ...
    """
    from promptreplay.bench.precheck import precheck_candidates
...
def _drop(result: PreCheckResult) -> SelectionDrop:
    from promptreplay.bench.selection import SelectionDrop
