...
from promptreplay.core.output import select_format
from promptreplay.core.params import StdinOrPath
from promptreplay.core.render import emit_result
from promptreplay.core.spec import CommandSpec

PLAIN_META = f"{__name__}:plain"
"""Context meta key under which `--plain` records its value (see `promptreplay.core.paging`).
