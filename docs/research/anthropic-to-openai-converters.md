...
Write a small, local converter in `provibench`, using LiteLLM's adapter as a reference rather than as a runtime dependency.
...
| Anthropic shape | OpenAI Chat Completions output | Decision for provibench |
|---|---|---|
