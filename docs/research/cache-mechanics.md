# Prompt-cache mechanics and `promptreplay`
...
4. DeepSeek explicitly persists request output boundaries, and the supplied trace confirms this in production: `promptreplay trace, 2026-09-12`.
...
## Measurement implications for `promptreplay`
